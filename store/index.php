	...
	<body style="color:#111111;">
		<div class="projects-clean" style="background:linear-gradient(0deg, <?php echo $background_gradient_bottom; ?>, <?php echo $background_gradient_top; ?>);color:#111111;">
		    <div class="container" style="padding-top:100px;">
	 	        <main>
                    <?php
                    // Depending on the current Balloon configuration, display a button to show an 'About' page.
                    ...
                    // Only show the admin control panel buttons if the current user is an admin user according to the current Balloon configuration.
				    ...
				    <div class="intro">
				        <h2 class="text-center" style="color:#dddddd">
                            <?php if ($display_balloon_logo == true) { echo '<img src="/balloon/assets/img/balloonlogosmall.svg" alt="Balloon logo" style="height:50px;margin-right:20px;">'; } ?>
                    ...
                    <?php
                    // Display "Monero Accepted" badge depending on the current Balloon configuration.
                    if ($display_monero_accepted_icon == 3) {
                        echo '
                        <div style="text-align:center;">
                            <img src="/balloon/assets/img/monerolarge.svg" alt="Monero accepted here" style="width:200px;margin:10px;">
                        </div>
                        ';
                    } else if ($display_monero_accepted_icon == 2) {
                        echo '
                        <div style="text-align:center;">
                            <img src="/balloon/assets/img/monerosmall.svg" alt="Monero logo" style="height:50px;margin:10px;">
                        </div>
                        ';
                    }
                    ?>
	                        ...
	                        foreach ($productsArray[$store_id] as $key => $element) {
                                if ($element["enabled"] == true and $element["inperson"] !== true) { // Only display this product if it is enabled in the product database and is not marked as an in-person product.
                                    ...
                                    if ($currency_conversion == true) {
                                        echo '<h2 style="padding:0px;margin-top:10px;margin-bottom:20px;font-size:1rem;color:#ffff;"><a href="https://duckduckgo.com/?q=' . $element["price"] . '+XMR+to+USD&ia=cryptocurrency" style="text-decoration:underline;color:white;">' . $element["price"] . ' XMR</a></h2>'; // Display this product's price
                                    } else {
                                        echo '<h2 style="padding:0px;margin-top:10px;margin-bottom:20px;font-size:1rem;color:#ffff;">' . $element["price"] . ' XMR</h2>'; // Display this product's price
                                    }
